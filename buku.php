...
$sql_total = mysqli_query($koneksi, 
...
<head>
    ...
    <style>
        ...
        .cover-img { 
            ...
            object-fit: cover; 
            border-radius: 5px;
            border: 2px solid #ffb6dd;
        }

        /* Tombol */
        .btn-primary {
            background-color: #ff5aa6 !important;
            border-color: #ff5aa6 !important;
        }
        .btn-primary:hover {
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-md-2 sidebar p-0">
            ...
            <div class="mt-3">
                <small class="text-uppercase px-3">Data Master</small>
                ...
                <small class="text-uppercase px-3 mt-3 d-block">Autentikasi</small>
                <a href="logout.php" class="text-white"><i class="fa-solid fa-right-from-bracket me-2"></i> Sign Out</a>
            </div>
        </div>
        ...
        <div class="col-md-10 content">
            ...
            <nav class="navbar navbar-light bg-white shadow-sm mb-4 rounded px-3">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <img src="https://ui-avatars.com/api/?name=<?= $_SESSION['username']; ?>&background=ff99cc" 
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h5 class="card-title mb-4">Daftar Buku</h5>
                        ...
                        <table class="table table-hover align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <small class="d-block">Penulis: <?= $row['penulis']; ?></small>
                                        <small class="d-block">Penerbit: <?= $row['penerbit']; ?></small>
                                    </td>
                    ...
                    <nav>
                        <ul class="pagination justify-content-end">
                            <li class="page-item <?= ($halaman <= 1) ? 'disabled' : ''; ?>">
                                <a class="page-link" 
                                   href="?halaman=<?= $previous ?>&cari=<?= $keyword ?>">
                                   Previous
                                </a>
                            </li>
                            ...
                            <li class="page-item <?= ($halaman == $x) ? 'active' : ''; ?>">
                                <a class="page-link" href="?halaman=<?= $x ?>&cari=<?= $keyword ?>">
                                    <?= $x ?>
                                </a>
                            </li>
                            <?php endfor; ?>
                            ...
                            <li class="page-item <?= ($halaman >= $total_halaman) ? 'disabled' : ''; ?>">
                                <a class="page-link" 
                                   href="?halaman=<?= $next ?>&cari=<?= $keyword ?>">
                                   Next
                                </a>
                            </li>
                        </ul>
